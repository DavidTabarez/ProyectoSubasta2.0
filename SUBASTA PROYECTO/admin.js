// ============================================================
// Panel administración SubastaNet
// Categorías con el mismo estilo visual que subasta.html
// ============================================================
...
// ---- Renderizar sección con categorías (igual visual que subasta) ----
function renderizarSeccion(contenedorEl, lista) {
  ...
  ORDEN_CATEGORIAS.forEach(cat => {
    ...
    // Sección por categoría igual que subasta.html
